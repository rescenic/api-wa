...
router.get("/find", async (req, res, next) => {
    ...
    if (apikey != "Rescenic") return res.json(loghandler.invalidKey);
...
router.get("/tiktod", async (req, res, next) => {
    ...
    if (!apikeyInput) return res.json(loghandler.notparam);
    if (apikeyInput != "Rescenic") return res.json(loghandler.invalidKey);
...
router.get("/base", async (req, res, next) => {
    ...
    if (!type)
        return res.json({
            ...
            code: 404,
            message:
                "masukan parameter type, type yang tersedia : base64 , base32",
        });
                    ...
                    if (!e) {
                        ...
                        $(".thumbnail")
                            ...
                            .each(function () {
                                ...
                                fetch(
                                    encodeURI(
                                        `https://api.imgbb.com/1/upload?expiration=120&key=93f5c8966cfaf3ca19051ee9f85c14f3&image=${result}&name=${randomTextNumber}`
                                    )
                                )
                                    .then((response) => response.json())
                                    .then((data) => {
                ...
                if (!e) {
                    ...
                    $(".thumbnail")
                        ...
                        .each(function () {
                            ...
                            fetch(
                                encodeURI(
                                    `https://api.imgbb.com/1/upload?expiration=120&key=761ea2d5575581057a799d14e9c78e28&image=${result}&name=${randomTextNumber}`
                                )
                            )
                                .then((response) => response.json())
                                .then((data) => {
...
router.get("/muslim/tahlil", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/dataTahlil.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/wirid", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/dataWirid.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/ayatkursi", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/dataAyatKursi.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/doaharian", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/dataDoaHarian.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/bacaanshalat", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/dataBacaanShalat.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/niatshalat", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/dataNiatShalat.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/kisahnabi", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/dataKisahNabi.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/asmaulhusna", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/dataAsmaulHusna.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/niatshubuh", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/NiatShubuh.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/niatdzuhur", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/NiatDzuhur.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/niatmaghrib", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/NiatMaghrib.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/muslim/niatashar", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/data/NiatAshar.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/wallpaper/cyberspace", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/CyberSpace.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/wallpaper/teknologi", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/Technology.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/wallpaper/muslim", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/Islamic.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/wallpaper/programming", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/Programming.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/wallpaper/pegunungan", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/My-SQL-Results/main/Mountain.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/wikipedia", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://docs-api-zahirrr.herokuapp.com/api/wiki?keyword=${search}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/randomquote/muslim", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://docs-api-zahirrr.herokuapp.com/api/quote?type=agamis`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/drakorasia", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `http://docs-api-zahirrr.herokuapp.com/api/drakorasia?search=${search}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/jadwalshalat", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://raw.githubusercontent.com/Zhirrr/Zhirrr-Database/main/adzan/${kota}/2021/03.json`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/fakedata", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://fakename-api-zhirrr.vercel.app/api/fakename?country=${country}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/hilih", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://hilih-api-zhirrr.vercel.app/api/hilih?kata=${kata}`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/liriklagu", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://python-api-zhirrr.herokuapp.com/api/lirik?search=${lagu}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/chordlagu", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://python-api-zhirrr.herokuapp.com/api/chord?q=${lagu}`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/random/asmaulhusna", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://python-api-zhirrr.herokuapp.com/api/random/asmaulhusna`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/covidindo", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://covid19-api-zhirrr.vercel.app/api/covid-indonesia`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/infocuaca", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://bmkg-api-zahirr.herokuapp.com/api/cuaca/${provinsi}`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/quotes/kanye", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://docs-api-zahirrr.herokuapp.com/api/quote?type=kanye`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/translate", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://docs-api-zahirrr.herokuapp.com/api/translate?text=${kata}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/anime/kusonime", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://docs-api-zahirrr.herokuapp.com/api/kusonime?search=${search}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/manga", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://docs-api-zahirrr.herokuapp.com/api/manga?keyword=${search}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/random/wallpaper", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://docs-api-zahirrr.herokuapp.com/api/random/wallpaper?genre=acak`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/kuis/caklontong", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://docs-api-zahirrr.herokuapp.com/api/quote?type=caklontong`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/kuis/tebakgambar", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://docs-api-zahirrr.herokuapp.com/api/quote?type=tebakgambar`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/news/republika", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://news-api-zhirrr.vercel.app/v1/republika-news/${type}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/news/antara", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://news-api-zhirrr.vercel.app/v1/antara-news/${type}`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/filmapik/search", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://filmapik-api-zahirr.herokuapp.com/search?q=${film}`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/filmapik/kategori", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://filmapik-api-zahirr.herokuapp.com/category?search=${film}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/lk21/search", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://lk21-api-zahirr.herokuapp.com/search?query=${film}`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/lk21/country", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://lk21-api-zahirr.herokuapp.com/country?country=${negara}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/lk21/genre", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://lk21-api-zahirr.herokuapp.com/genre?genre=${tipe}`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/textmaker/random", async (req, res, next) => {
    ...
    if (apikeyInput != "Rescenic") return res.json(loghandler.invalidKey);
    if (!theme) return res.json(loghandler.nottheme);
    if (theme != "text-burn" && theme != "art-quote")
        return res.json(loghandler.notheme);
    if (!text) return res.json(loghandler.nottext);
...
router.get("/textmaker/roses", async (req, res, next) => {
    ...
    if (apikeyInput != "Rescenic") return res.json(loghandler.invalidKey);
    if (!theme) return res.json(loghandler.nottheme);
    if (theme != "wooden-boarch" && theme != "golden")
        return res.json(loghandler.notheme);
    if (!text) return res.json(loghandler.nottext);
...
router.get("/yutub/video", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://python-api-zhirrr.herokuapp.com/api/ytv?url=${url}`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/yutub/audio", async (req, res, next) => {
    ...
    fetch(
        encodeURI(`https://python-api-zhirrr.herokuapp.com/api/yta?url=${url}`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/ig/stalk", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://python-api-zhirrr.herokuapp.com/api/stalk?username=${username}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/maker", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://textmaker-api-zahirr.herokuapp.com/api/textmaker?text=${text}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/maker2", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://textmaker-api-zahirr.herokuapp.com/api/textmaker2?text=${text}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/maker3", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://textmaker-api-zahirr.herokuapp.com/api/textmaker3?text=${text}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/maker4", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://textmaker-api-zahirr.herokuapp.com/api/textmaker4?text=${text}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/maker3d", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://textmaker-api-zahirr.herokuapp.com/api/text3d?text=${text}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/maker3d/no2", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://textmaker-api-zahirr.herokuapp.com/api/text3d-2?text=${text}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/maker3d/no3", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://textmaker-api-zahirr.herokuapp.com/api/text3d-3?text=${text}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/maker3d/no4", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://textmaker-api-zahirr.herokuapp.com/api/text3d-4?text=${text}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/yutub/search", async (req, res, next) => {
    ...
    if (!video)
        return res.json({
            status: false,
            creator: `${creator}`,
            message: "masukan parameter video",
        });

    fetch(
        encodeURI(`https://yutub-api-zaahirr.herokuapp.com/search?q=${video}`)
    )
        .then((response) => response.json())
        .then((data) => {
            var result = data;
...
router.get("/maker/special/transformer", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://textmaker-api-zahirr.herokuapp.com/api/special/transformer?text=${text}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
...
router.get("/maker/special/epep", async (req, res, next) => {
    ...
    fetch(
        encodeURI(
            `https://textmaker-api-zahirr.herokuapp.com/api/special/sertifikatepep?text=${text}`
        )
    )
        .then((response) => response.json())
        .then((data) => {
